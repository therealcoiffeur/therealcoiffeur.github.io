...
## Reflect XSS in a GET parameter `sall`
...
> New payload: `<input autofocus on<--! -->focus=alert(1339) <--!`
...
## Stored XSS in a POST parameter `joinfiles`
...
## [UPDATE]: Stored XSS in a POST parameter `address`

Identification of a new parameter allowing the exploitation of a stored XSS for path <span style="color:red">\<ROOT\>user/card.php</span>.
...
![alt text](../captures/c17_21.png "Figure 20: Getting RCE 2")

Including the administrator:

![alt text](../captures/c17_22.png "Figure 21: Getting RCE 2")
