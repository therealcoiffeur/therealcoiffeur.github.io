...
And try to create a delay of 12 seconds by replacing 0 by 10.

![alt text](../captures/c18_12.png "Figure 9: Burp capture 3")

We understand that it is therefore possible to exploit this vulnerability by exploiting a Time Based SQL injection.
{% endraw %}